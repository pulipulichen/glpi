<?php
/*
 * @version $Id: knowbaseitem.class.php 14684 2011-06-11 06:32:40Z remi $
 -------------------------------------------------------------------------
   ...
   **/
   function showForm($ID, $options=array()) {
      ...
      if ($canedit) {
         ...
         {
             Dropdown::show('KnowbaseItemCategory',
                            array('value' => $options['knowbaseitemcategories_id']));
         }
         echo "</div></fieldset>";
   ...
   function showMenu() {
      ...
      if ($edit) {
         ...
         echo "<img src=\"".$CFG_GLPI["root_doc"]."/pics/faqedit.png\" alt=\"".$LANG['knowbase'][8].
               "\" title=\"".$LANG['knowbase'][8]."\"> ".$LANG['knowbase'][8]."</a></td>\n";
         ...
         echo "<img src=\"".$CFG_GLPI["root_doc"]."/pics/faqdelete.png\" alt=\"".$LANG['knowbase'][9].
               "\" title=\"".$LANG['knowbase'][9]."\"> ".$LANG['knowbase'][9]."</a></td>";
         echo "</tr>";
      }
      echo "</table><br>";
   }
               ...
               if ($output_type==HTML_OUTPUT) {
                  ...
                  echo Search::showItem($output_type,
                                        "<div class='kb'><a ".
                                          ...
                                          " $href>".resume_text($data["question"], 80)."</a>".
