...
class PluginProjetProfile extends CommonDBTM {
	...
	static function getTypeName() {
      ...
      return $LANG['plugin_projet']['profile'][0];
   }
   ...
   static function changeProfile() {
      ...
      if ($prof->getFromDBByProfile($_SESSION['glpiactiveprofile']['id'])) {
         ...
         $_SESSION['glpiactiveprofile']['helpdesk_item_type'][] = "PluginProjetProjet";
      } else {
         unset($_SESSION["glpi_plugin_projet_profile"]);
         unset($_SESSION["glpiactiveprofile"]['helpdesk_item_type']['PluginProjetProjet']);
      }
   }
   ...
   //profiles modification
	function showForm ($ID, $options=array()) {
      ...
      $this->showFormHeader($options);
		...
		echo "<th colspan='4' class='center b'>".$LANG['plugin_projet']['profile'][0]." ".$prof->fields["name"]."</th>";

		echo "</tr>";
		echo "<tr class='tab_bg_2'>";
		
		echo "<td>".$LANG['plugin_projet']['profile'][1].":</td><td>";
		Profile::dropdownNoneReadWrite("projet",$this->fields["projet"],1,1,1);
		echo "</td>";

		echo "<td>".$LANG['plugin_projet']['title'][3].":</td><td>";
		...
		echo "<td>" . $LANG['setup'][352] . " - " . $LANG['plugin_projet']['title'][1] . ":</td><td>";
