...
ajaxUpdateItemOnSelectEvent("dropdown_plan[_duration]$rand",
         "date_end$rand",$CFG_GLPI["root_doc"]."/plugins/projet/ajax/planningend.php",$params,false);


if($default_delay==0){
   $params['duration']=0;
   ajaxUpdateItem("date_end$rand",$CFG_GLPI["root_doc"]."/plugins/projet/ajax/planningend.php",$params);
}
