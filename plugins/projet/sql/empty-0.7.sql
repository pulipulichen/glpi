DROP TABLE IF EXISTS `glpi_plugin_project`;
CREATE TABLE `glpi_plugin_project` (
...
DROP TABLE IF EXISTS `glpi_plugin_project_items`;
CREATE TABLE `glpi_plugin_project_items` (
	`ID` int(11) NOT NULL auto_increment,
	...
	`is_template` smallint(6) NOT NULL default '0',
	PRIMARY KEY  (`ID`),
	KEY `FK_device` (`FK_device`,`FK_project`),
	KEY `FK_project` (`FK_project`),
	KEY `FK_device_2` (`FK_device`),
	KEY device_type (`device_type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

DROP TABLE IF EXISTS `glpi_plugin_project_tasks`;
CREATE TABLE `glpi_plugin_project_tasks` (
	`ID` int(11) NOT NULL auto_increment,
	`name` varchar(250) collate utf8_unicode_ci NOT NULL default '',
	`project` int(4) NOT NULL default '0',
...
DROP TABLE IF EXISTS `glpi_plugin_project_tasks_items`;
...
DROP TABLE IF EXISTS `glpi_dropdown_plugin_project_status`;
...
DROP TABLE IF EXISTS `glpi_dropdown_plugin_project_tasks_type`;
CREATE TABLE `glpi_dropdown_plugin_project_tasks_type` (
	`ID` int(11) NOT NULL auto_increment,
	`FK_entities` int(11) NOT NULL default '0',
	`name` varchar(255) collate utf8_unicode_ci NOT NULL default '',
	`comments` text,
...
DROP TABLE IF EXISTS `glpi_dropdown_plugin_project_task_status`;
...
DROP TABLE IF EXISTS `glpi_plugin_project_mailing`;
...
DROP TABLE IF EXISTS `glpi_plugin_project_profiles`;
CREATE TABLE `glpi_plugin_project_profiles` (
	`ID` int(11) NOT NULL auto_increment,
	`name` varchar(255) collate utf8_unicode_ci default NULL,
	`interface` varchar(50) collate utf8_unicode_ci NOT NULL default 'project',
